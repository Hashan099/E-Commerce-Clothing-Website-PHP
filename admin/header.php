	...
	<div class="wrapper">
		...
		<header class="main-header">
			...
			<a href="index.php" class="logo">
				<span class="logo-lg">Celene Clothing</span>
			</a>
  		...
  		<aside class="main-sidebar">
    		<section class="sidebar">
      			...
      			<ul class="sidebar-menu">
			        ...
			        <li class="hidden <?php if( ($cur_page == 'settings.php') ) {echo 'active';} ?>">
			          <a href="settings.php">
			        ...
			        <li class="hidden <?php if( ($cur_page == 'service.php') ) {echo 'active';} ?>">
			          <a href="service.php">
