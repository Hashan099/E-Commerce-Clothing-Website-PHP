...
<div id="bootstrap-touch-slider" class="carousel bs-slider fade control-round indicators-line" data-ride="carousel" data-pause="hover" data-interval="false" >
    ...
    .carousel-inner .item {
        height: 100%; /* Ensures each item takes the full height of the carousel */
    ...
    .bs-slider-overlay {
        ...
        width: 100%;
        height: 100%;
        background: rgba(0, 0, 0, 0.5); /* Optional: darkens the overlay */
    }
...
<div class="service"  style="background-color:#EDEADE">
    <div class="container"  style="background-color:#EDEADE">
        <div class="row">
            <?php
...
<div class="product pt_70 pb_70" style="background-color:#EDEADE">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="headline">
                    ...
                    foreach ($result as $row) {
                        ...
                        <div class="item">
                            ...
                            <div class="text">
                                ...
                                <h4>
                                <?php echo LANG_VALUE_1; ?> <?php echo number_Format($row['p_current_price']); ?> 
                                    <?php if($row['p_old_price'] != ''): ?>
                                    <del>
                                    <?php echo LANG_VALUE_1; ?> <?php echo number_Format($row['p_old_price']); ?>
                                    </del>
                                    <?php endif; ?>
                                </h4>
                                <div class="rating">
...
<div class="product pt_70 pb_30" style="background-color:#EDEADE">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="headline">
