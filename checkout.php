                ...
                <div class="cart">
                    <table class="table table-responsive table-hover table-bordered">
                        ...
                        <tr>
                            ...
                            <td><?php echo LANG_VALUE_1; ?><?php echo number_Format($arr_cart_p_current_price[$i]); ?></td>
                            ...
                            <td class="text-right">
                                ...
                                ?>
                                <?php echo LANG_VALUE_1; ?><?php echo number_Format($row_total_price); ?>
                            </td>
                        </tr>
                        <?php endfor; ?>           
                        <tr>
                            <th colspan="7" class="total-text"><?php echo LANG_VALUE_81; ?></th>
                            <th class="total-amount"><?php echo LANG_VALUE_1; ?><?php echo number_Format($table_total_price); ?></th>
                        </tr>
                        <?php
                        ...
                        <tr>
                            ...
                            <td class="total-amount"><?php echo LANG_VALUE_1; ?><?php echo number_Format($shipping_cost); ?></td>
                        </tr>
                        <tr>
		                ...
		                <?php if($checkout_access == 0): ?>
		                	<div class="col-md-12">
				                <div style="color:red;font-size:22px;margin-bottom:50px;">
			                        You need to fill up all the billing and shipping information from your dashboard panel in order to checkout the order. Please fill up the information going to <a href="customer-billing-shipping-update.php" style="color:red;text-decoration:underline;">this link</a>.
			                    </div>
	                    	</div>
	                	<?php else: ?>
		                	<div class="col-md-4">
