...
<!-- top bar -->
<div class="top"  style="background-color:blue">
	<div class="container">
		<div class="row">
...
<div class="header"  style="background-color:#EDEADE">
	<div class="container">
		<div class="row inner">
				...
				<ul>
					...
					if(isset($_SESSION['cart_p_id'])) {
	                    ...
	                    for($i=1;$i<=count($arr_cart_p_qty);$i++) {
   						 ...
   						 $formatted_total_price = number_format($table_total_price, 2, '.', ',');
						echo LANG_VALUE_1 . $formatted_total_price;
						} else {
						echo 'LKR 0.00';
					}
					?> )</a></li>
			...
			<div class="col-md-3 search-area" >
				<form class="navbar-form navbar-left" role="search" action="search-result.php" method="get">
					...
					<button type="submit" class="btn btn-primary" style="background-color:blue"><?php echo LANG_VALUE_3; ?></button>
				</form>
			</div>
		</div>
	</div>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-12 pl_0 pr_0">
				<div class="menu-container" style="background-color:blue">
					<div class="menu">
						<ul>
