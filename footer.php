...
<section class="home-newsletter"  style="background-color:blue	">
	<div class="container">
		<div class="row">
			    ...
			    else
			    {
				    ...
				    else
				    {
				    	...
				    	else
				    	{
				    		...
				    		$statement = $pdo->prepare("INSERT INTO tbl_subscriber (subs_email,subs_date,subs_date_time,subs_active) VALUES (?,?,?,?)");
							...
							$message = '
							Thank you for subscribing to our newsletter! <br> Stay tuned for our latest offers and Discounts <br>';
												...
												try {
													...
													$mail->send();
													echo "<script>alert('Thank you subscribing to our newsletter!')</script>";
												} catch (Exception $e) {
